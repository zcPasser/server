...
{
    // --- mysql数据库配置---
    string db_host = config_file::instance()->get_string("mysql", "db_host", "127.0.0.1");
    short db_port = config_file::instance()->get_number("mysql", "db_port", 3306);
    string db_user = config_file::instance()->get_string("mysql", "db_user", "root");
    string db_passwd = config_file::instance()->get_string("mysql", "db_passwd", "aceld");
    string db_name = config_file::instance()->get_string("mysql", "db_name", "lars_dns");
